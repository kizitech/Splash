...
import { Sizes, Colors, NavBarDark } from "src/components";
...
export default function Cart() {
    ...
    return <>
        ...
        <div className="cart-empty">
            <h2 style={{textAlign: "center", fontSize: "3.5rem"}}>Your Cart Is Empty</h2>
        </div>
    </>
  ...
  {cart.map((product) => (
    <div key={product._id} className="cart__product">
      <img src={product.images[0]} alt="" className="cart__product-image" />
      ...
      <div className="cart__product-details">
        ...
        <div className="cart__product-quantity">
          <button
            ...
            className="cart__product-quantity-btn cart__product-quantity-btn--reduce"
          >
            -
          </button>
          ...
          <button
            ...
            className="cart__product-quantity-btn cart__product-quantity-btn--increase"
          >
            +
          </button>
        </div>
  ...
  <div className="cart__summary">
    <Link to="/payment" className="cart__summary-link">Pay</Link>
