          ...
          <div className="home__hero">
            ...
            <div className="home__hero-content">
              ...
              <Link to="/shop" className="home__hero-link">
                <button type="button" className="home__hero-button wt-btn_sign">
                  <span className="wt-btn_sign-bound">
                    <span data-width="#fff" data-text="Start Shopping">
                      Start Shopping
                    </span>
                  </span>
                </button>
          ...
          <div className="home__top-collection">
            ...
            <div className="home__top-collection-container">
              {homeProducts.map((homeProduct) => (
                <div
                  className="home__top-collection-item"
                  key={homeProduct._id}
                >
                  <Link
                    className="home__top-collection-image"
                    to={`/shop/home-products/${homeProduct._id}`}
                  >
                  ...
                  <div className="home__top-collection-details">
                    <div className="home__top-collection-text">
                      <h3
                        className="home__top-collection-title"
                        title={homeProduct.title}
                      >
                        <Link to={`/shop/home-products/${homeProduct._id}`}>
                          {homeProduct.title}
                        </Link>
                      </h3>
                    ...
                    <div className="home__top-collection-buttons">
                      <Link
                        className="home__top-collection-buttons-buy"
                        to={`/shop/home-products/${homeProduct._id}`}
                      >
                        Buy Now
                      </Link>
                      <Link
                        className="home__top-collection-buttons-add"
            ...
            <div className="home__latest-arrivals-container">
              {latestArrivals.map((model) => (
                <div className="home__latest-arrivals-item" key={model.id}>
                  <img
                    className="home__latest-arrivals-image"
                    src={model.image}
                    alt={model.alt}
                  />
                  <div className="home__latest-arrivals-details">
                    <h2 className="home__latest-arrivals-title">
                      {model.title}
                    </h2>
                    <p className="home__latest-arrivals-description">
                      {model.description}
                    </p>
