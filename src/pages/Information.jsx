        ...
        <div className="information__content">
          <section className="information__section">
            ...
            <div className="information__payment">
              <div className="information__payment-paypal" title="paypal">
                <img src={paypal} alt="PayPal" />
              </div>
              <div className="information__payment-paystack" title="paystack">
                <img src={paystack} alt="Paystack" />
              </div>
            </div>
            <div className="information__divider">
              <hr className="information__divider-line" />
              <span className="information__divider-text">OR</span>
              <hr className="information__divider-line" />
            </div>
          </section>
          ...
          <section className="information__section">
            ...
            <form className="information__form" action="">
              <Dropdown
                options={countryName}
                className="information__country-dropdown"
              />
              <div className="information__form-name">
                <input
                  type="text"
                  className="information__input information__input--half"
                  name="firstName"
